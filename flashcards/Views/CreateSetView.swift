...
struct CreateSetView: View {
    ...
    @State var cards: [Flashcard] = [Flashcard(question: "", answer: "", isStarred: false)]
        ...
        VStack {
            ...
            ScrollView {
                ...
                Button("Add Card") {
                    ...
                    withTransaction(t) {
                        $cards.wrappedValue.append(Flashcard(question: "", answer: "", isStarred: false))
                    }
                }
            }
    ...
    func saveSet() async {
        ...
        let newSet : FlashcardSet = FlashcardSet(title: setName, color: selectedColor, updatedAt: Date(), cards: actualCards, isPublic: true, shareCode: nil, ownerId: Auth.auth().currentUser?.uid)
        onSave(newSet)
